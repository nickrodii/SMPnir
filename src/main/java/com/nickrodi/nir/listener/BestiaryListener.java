...
public class BestiaryListener implements Listener {
    ...
    /**
     * Tracks ONLY horse markings (style), not color.
     * Styles: NONE, WHITE, WHITE_FIELD, WHITE_DOTS, BLACK_DOTS
     */
    private String horseId(Horse horse) {
        ...
        return switch (style) {
            case NONE -> "horse_plain";
            case WHITE -> "horse_white_stockings";
            case WHITEFIELD -> "horse_white_field";
            case WHITE_DOTS -> "horse_white_spotted";
            case BLACK_DOTS -> "horse_black_dotted";
        };
    }
